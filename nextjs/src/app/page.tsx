          ...
          <div className="max-w-[800px]">
            <div className="grid md:grid-cols-[1fr_1.4fr] gap-px bg-zinc-800/60">
              <div className="bg-[#09090b] p-8 md:p-9">
                ...
                <a href="https://creem.io/product/prod_4gXTSUiUWPm1Lq4wXFyq6i" className="block text-center h-12 leading-[48px] font-mono text-[13px] tracking-wider text-zinc-500 border border-zinc-800 hover:text-zinc-300 hover:border-zinc-600 transition-colors no-underline">Start free trial</a>
              </div>
              <div className="bg-[#0b0b0d] p-8 md:p-9">
                ...
                <a href="https://creem.io/product/prod_3ekPhydbb03vV7MUvTRH8p" className="block text-center h-12 leading-[48px] font-mono text-[13px] tracking-wider bg-amber-500 text-black hover:bg-amber-600 transition-colors no-underline">Start free trial</a>
              </div>
            </div>
